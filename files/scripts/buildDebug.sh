...
# cmake it!
cd ${GAMBIT_DIR}/build && \
cmake -D CMAKE_CXX_COMPILER=g++ -D CMAKE_C_COMPILER=gcc -D CMAKE_Fortran_COMPILER=gfortran -D CMAKE_BUILD_TYPE=Debug -D WITH_MPI=ON -D BUILD_FS_MODELS="THDM_I;THDM_II;THDM_LS;THDM_flipped" -D WITH_ROOT=ON -D WITH_RESTFRAMES=ON -D WITH_HEPMC=ON -D EIGEN3_INCLUDE_DIR=/ccc/products/eigen-3.2.8/default/include/ .. && \
echo "\n\n\n\n"
